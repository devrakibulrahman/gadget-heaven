...
const ProductWishListCard = ({wishlist}) => {
    const {handleDeleteDataToWishlist} = useContext(WishListContext);
            ...
            <div className={`w-full flex flex-col gap-y-3 sm:gap-y-5 md:flex-row md:gap-x-6 lg:gap-x-7 xl:gap-x-8`}>
                ...
                <div className={`w-full mt-5 sm:mt-0`}>
                    ...
                    <div className={`w-auto mt-4 flex items-center justify-between`}>
                        <button onClick={() => {handleCart(wishlist, saveCartDataIds), handleDeleteDataToWishlist(wishlist)}} className='w-auto h-[45px] px-[22px] bg-[#9538E2] flex items-center gap-x-[10px] border border-[#9538E2] rounded-full md:h-[48px]'>
